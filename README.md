...
Loopforge 是一套面向 AI 编程助手（如 Trae IDE）的 **Skill 与 Rules 配置体系**。定义了 **Loop Engineering** 的迭代自审流程：让 AI 对代码进行 6 轮有序的审查—修复—验证循环，每轮聚焦一个质量维度，配合 5 个联动 Skill 协同工作，逐步消除逻辑错误、状态问题、交互缺陷和性能隐患。
